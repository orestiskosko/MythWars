...
namespace DomainModels
{
    ...
    public enum UnitsEnum { Minotaur, Cyclops, Centaur, Phoenix, Sphinx, Mummy, Giant, Valkyrie, Viking }  // some dummy units ideas  {maybe separate later according to Mythology origin}
